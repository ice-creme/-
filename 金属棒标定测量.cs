...
public partial class HDevelopExport
{
  ...
  private void action()
  {
    ...
    HObject ho_Imagebd, ho_Image, ho_Imagedc, ho_Image2;
    ...
    HOperatorSet.GenEmptyObj(out ho_Imagebd);
    HOperatorSet.GenEmptyObj(out ho_Image);
    HOperatorSet.GenEmptyObj(out ho_Imagedc);
    HOperatorSet.GenEmptyObj(out ho_Image2);
    //读取图像1
    ho_Imagebd.Dispose();
    HOperatorSet.ReadImage(out ho_Imagebd, "C:/Users/夏目家的猫/Desktop/3mm.JPG");
    //显示窗口
    ...
    ho_Image.Dispose();
    HOperatorSet.CopyObj(ho_Imagebd, out ho_Image, 1, 1);
    ...
    if (HDevWindowStack.IsOpen())
    {
      HOperatorSet.DispObj(ho_Imagebd, HDevWindowStack.GetActive());
    }
    //计算
    ...
    //读取图像2
    ho_Imagedc.Dispose();
    HOperatorSet.ReadImage(out ho_Imagedc, "C:/Users/夏目家的猫/Desktop/5mm.JPG");
    HOperatorSet.SetWindowAttr("background_color","black");
    HOperatorSet.OpenWindow(0,0,512,512,0,"visible","",out hv_WindowHandle);
    HDevWindowStack.Push(hv_WindowHandle);
    if (HDevWindowStack.IsOpen())
    ...
    ho_Image2.Dispose();
    HOperatorSet.CopyObj(ho_Imagedc, out ho_Image2, 1, 1);
    ...
    if (HDevWindowStack.IsOpen())
    {
      HOperatorSet.DispObj(ho_Imagedc, HDevWindowStack.GetActive());
    }
    //测量尺寸
